...
class ListFetcher {
	...
	/**
	 * Fetches the latest revision/date available from GitHub mozilla-firefox/firefox
	 *
	 * @return string[]
	 */
	public function getLatestInfo(): array {
		// phpcs:ignore Generic.Files.LineLength
		$changesUrl = 'https://api.github.com/repos/mozilla-firefox/firefox/commits?sha=main&per_page=1&path=security%2Fmanager%2Fssl%2FnsSTSPreloadList.inc';
		$json = json_decode(
			file_get_contents(
				$changesUrl,
				false,
	...
	public function fetchList( $rev, $date ) {
		...
		// phpcs:ignore Generic.Files.LineLength
		$url = "https://github.com/mozilla-firefox/firefox/raw/{$rev}/security/manager/ssl/nsSTSPreloadList.inc";
		$lines = explode( "\n",
			file_get_contents(
				$url,
				false,
		...
		$inList = false;
		$header = <<<HEADER
Generated by fetchList.php using mozilla-firefox/firefox@$rev ($date)
